...
server.get(
  ...
  patientsHandler.get_all_patients
);
// Get a single patient by their patient id
server.get(
  "/patients/:id",
  userHandlers.loginRequired,
  patientsHandler.get_a_patient_by_id
);
// Update a single patient by its patient id
server.put(
  "/patients/:id",
  userHandlers.loginRequired,
  patientsHandler.update_a_patient_by_id
);
// Create a new patient
server.post(
  "/patients",
  userHandlers.loginRequired,
  patientsHandler.create_a_patient
);
// Delete patient with the given id
server.del(
  "/patients/:id",
  userHandlers.loginRequired,
  patientsHandler.delete_a_patient_by_id
);
// Records
...
server.get(
  "/patients/:id/records",
  userHandlers.loginRequired,
  clinicalDataHandler.get_all_records_by_patient_id
);
// Create a single record by its patient id
server.post(
  "/patients/:id/records",
  userHandlers.loginRequired,
  clinicalDataHandler.create_a_record_by_patient_id
);
// Get a record by its record id
server.get(
  "/records/:id",
  userHandlers.loginRequired,
  clinicalDataHandler.get_a_record_by_id
);
// Update a record by its record id
server.put(
  "/records/:id",
  userHandlers.loginRequired,
  clinicalDataHandler.update_a_record_by_id
);
// Delete a record with the given id
server.del(
  "/records/:id",
  userHandlers.loginRequired,
  clinicalDataHandler.delete_a_record_by_id
);
